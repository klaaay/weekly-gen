...
def scrape_nodeweekly():
    ...
    if response.status_code == 200:
        ...
        if link_url:
            ...
            if check_and_skip_if_same_issue(script_name, link_url, "https://nodeweekly.com"):
                return
            
            # 记录上次运行抓取的 issue_link 信息
            issue_info = create_issue_info(issue_title, link_url, "https://nodeweekly.com")
            ...
            if link_response.status_code == 200:
                ...
                extract_links_and_summarize(
                    ...
                    on_complete=create_telegram_completion_callback("Node Weekly"),
                )
            else:
