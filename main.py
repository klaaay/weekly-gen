...
# 导入所有脚本的主函数
try:
    from frontendfoc import scrape_frontendfoc
    from javascriptweekly import scrape_javascriptweekly
    from nextjsweekly import scrape_nextjsweekly
    from nodeweekly import scrape_nodeweekly
    from reactweekly import scrape_reactweekly
    from reactdigest import scrape_reactdigest
    from thisweekinreact import scrape_thisweekinreact
    from webtoolsweekly import scrape_webtoolsweekly
