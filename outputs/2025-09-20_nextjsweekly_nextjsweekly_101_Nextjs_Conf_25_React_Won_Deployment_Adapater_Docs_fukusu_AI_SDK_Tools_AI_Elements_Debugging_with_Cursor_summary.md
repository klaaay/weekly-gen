...
**原文标题**: [GitHub - gridatek/tailwind-typography: CSS-only version of Tailwind Typography plugin for Tailwind CSS v4 with all prose variants.](https://github.com/gridatek/tailwind-typography)
